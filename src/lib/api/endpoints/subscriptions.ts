...
/**
 * Subscription endpoints for the authenticated app.
 *
 * The app shows the user's plan / entitlements and surfaces the membership
 * page; it does not initiate purchases (that lives in novasafe-auth-v2's
 * Pro signup flow).
 */
