 ...
 * identical cookie names/attributes for the cross-subdomain session to work.
 *
 * Built on TanStack Start's request-scoped cookie primitives so callers don't
 * have to shuffle Headers around themselves.
 */

if (runtime.isBrowser) {
  throw new Error("[novasafe-app] session.server.ts was imported from the browser bundle.");
}
